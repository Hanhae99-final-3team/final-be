...
|상품 상세 페이지|✅단일 상품 조회<br>✅조회한 상품 쿠키 발급<br>✅조회 수 증가<br>✅평균 가격 호출<br>✅상품 찜 기능<br>✅댓글 CRUD <br> ✅상품 등록자와의 채팅방 생성<br>
...
|찜 리스트|✅찜 리스트<br>|
|최근 본 상품|✅최근 본 상품<br>|
|채팅창|✅채팅 생성<br> ✅채팅 전송<br>|
|채팅 리스트|✅기존 채팅 상대와 채팅방 연결<br>|
...
### 4. 고객 사용 편의를 위한 채팅 api변경

|구분|설명|
|:---:|---|
|문제<br>상황|기존의 채팅은 사람과 사람을 통해서 채팅 방을 생성하는데, 물품 거래 사이트의 경우 사람을 보고 채팅을 하는 경우 보다 상품을 보고 채팅을 하는 경우가 많음.
|문제<br>원인|채팅방을 사람을 보고 생성하면 사람 대 사람의 채팅방이 하나만 생성 됨. 그렇기에 다수의 상품을 거래중이라면 무슨 상품을 거래중인지 구분하기 힘듬.
|문제<br>해결|api 설계 방향을 사람-사람 의 채팅 방에서 사람-물건 채팅 방으로 변경.
|해결<br>결과|같은 사람과 대화를 하더라도 상품이 다르면 채팅방이 생성되고 무슨 상품을 거래중인지 알 수 있게 됨.
