...
|해결결과|현재 프로젝트 DB Table row는 많지 않아 큰 차이를 확인 할 수 없었으나 Test용 DB를 생성하여 약 100만 건의 더미데이터를 활용하여 성능 테스트를 해본 결과 기존 like %input% 방식의 검색 메서드 대비 약 116%의 성능 향상을 확인할 수 있었습니다.<br><img width="602" alt="image" src="https://user-images.githubusercontent.com/108924263/193781160-d8b87876-78eb-443b-aa15-1256fb990b91.png"> |
